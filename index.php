                        ...
                        while($row = $result->fetch_assoc()){
                                ...
                                echo"<div class='card-job' style='border-radius:40px;border: 1px solid #ccc;display: flex;padding:20px;margin-top:20px;flex-wrap:wrap;'>";
                                    ...
                                    echo"<form method='POST'style='align-self: center;'>";
                                        echo"<input type='submit' style='border-radius:10px;text-decoration:none;padding:15px 25px;margin-top:20px;display:inline-block;border:1px solid #ccc;background-color:#ccc;'  value='View' name='btnView'></a>";
                                        echo "<br>";
                                        echo"<input type='submit' style='border-radius:10px;text-decoration:none;padding:15px 25px;margin-top:20px;display:inline-block;border:1px solid #ccc;background-color:#ccc;'  value='♡♡♡' name='btnLove'></a>";
                                    echo"</form>";
                                echo"</div>";
                                echo "<style>";
                                echo ".card-job:hover{
