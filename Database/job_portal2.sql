...
(1002, 8, 'Company 2', '033124123', 'Company2@gmail.com', '');
-- --------------------------------------------------------
...
--
ALTER TABLE `client`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5003;
